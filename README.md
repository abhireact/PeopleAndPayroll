 Fix mindcom image in sidenav for different systems
Role --- fix  update
Designation --- fix delete
Create employee ----fix  role , designation , department   autocomepletes 
EPF -- fix employee and employer contribution rate 
Create earning --- Basic salary autcomplete option --- fix date fields 
Earning --- on delete reload needed
Pre-Tax deduction --- relaod  needed after create and delete  pre-tax deduction, fix update 
Post-Tax deduction --- relaod  needed after create and delete  pre-tax deduction, fix update and status 
Authentication --- fix or remove  some links
Reports --- activity logs ---show button
...
- Buy React Version from [Mindcom Group](https://www.creative-tim.com/product/material-dashboard-pro-react?ref=readme-mdpr).
- Buy React + TypeScript Version from [Mindcom Group](https://www.creative-tim.com/product/material-dashboard-2-pro-react-ts?ref=readme-mdpr).
...
- Copyright 2023 [Mindcom Group](https://www.creative-tim.com?ref=readme-mdpr)
- Mindcom Group [license](https://www.creative-tim.com/license?ref=readme-mdpr)

## Useful Links

- [More products](https://www.creative-tim.com/templates?ref=readme-mdpr) from Mindcom Group

- [Tutorials](https://www.youtube.com/channel/UCVyTG4sCw-rOvB9oHkzZD1w)

- [Freebies](https://www.creative-tim.com/bootstrap-themes/free?ref=readme-mdpr) from Mindcom Group
