...
export default function LeaveDistributionReport() {
  ...
  useEffect(() => {
    axios
      .get("http://10.0.20.133:8000/apply_leave/report/designation", {
        headers: {
  ...
  useEffect(() => {
    axios
      .get("http://10.0.20.133:8000/apply_leave/report/department", {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
        },
      ...
      let response;
      {
        selectedOption === "department"
          ? (response = await axios.post(
              "http://10.0.20.133:8000/apply_leave/report/department",
              values,
              {
                headers: {
                  "Content-Type": "application/json",
      ...
      const fetchData = async () => {
        try {
          ...
          if (selectedOption === "department" && departmentData[clickedSliceData.dataIndex]) {
            ...
            responsetabledata = await axios.post(
              "http://10.0.20.133:8000/apply_leave/report/designation",
              formValues,
              {
                headers: {
                  "Content-Type": "application/json",
            ...
            responsetabledata = await axios.post(
              "http://10.0.20.133:8000/apply_leave/report/location",
              formValues,
              {
                headers: {
                  "Content-Type": "application/json",
